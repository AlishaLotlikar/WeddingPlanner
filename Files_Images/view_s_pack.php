...
<body>
	...
	<?php 
		...
		if ($result->num_rows > 0) 
		{
			...
			{
				$pckgid=$row['pckgid'];	
				echo "<tr><th colspan='2'> Silver Package : ".$i."</th><th rowspan='9'></th></tr>";
				...
				echo "<tr><td> <a onClick=\"javascript: return confirm('ARE YOU SURE YOU WANT TO DELETE ?');\" 
							   href='delete_s_pack.php? pckgid=$pckgid'>Delete</a></tr>";
