...
<?php
	...
	if (isset($_POST['upload'])) 
	{
		...
		$sql="INSERT INTO package(PckgType)VALUES('Silver')";
		//$conn->query($sql);
		if (mysqli_query($conn, $sql)) 
		{
			$last_id = mysqli_insert_id($conn);
			$sql="INSERT INTO silverpackage(Pckgid, Hid, Cid, Did, Caid, djid, Mcid, bandid, cakid)VALUES
...
?>
	...
	<body>
		<center><h1> Silver Package </h1></center>
		<hr>
		<form method="post" action="silver_pack.php">
