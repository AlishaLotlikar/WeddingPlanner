...
<body>
	...
	<?php 
		...
		if ($result->num_rows > 0) 
		{
			...
			{
				$Pckgid=$row['Pckgid'];	
				echo "<tr><th colspan='2'> Gold Package : ".$i."</th><th rowspan='9'> </th></tr>";
				...
				echo "<tr><td> <a onClick=\"javascript: return confirm('ARE YOU SURE YOU WANT TO DELETE ?');\" 
							   href='delete_g_pack.php? Pckgid=$Pckgid'>Delete</a></tr>";
